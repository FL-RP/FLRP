...
namespace outRp.OtherSystem.Textlabels
{
    ...
    public class PlayerLabel : Entity, IEntity
    {
        ...
        public void Delete()
        {
            if(PlayerLabel.LabelList.Contains(this))
    ...
    public static class TextLabelStreamer
    {
        ...
        public static bool DestroyDynamicTextLabel(ulong dynamicTextLabelId)
        {
            ...
            if (PlayerLabel.LabelList.Contains(obj))
        ...
        {
            if (PlayerLabel.LabelList.Contains(dynamicTextLabel))
        ...
        {
            var labels = PlayerLabel.LabelList;

            /*lock (PlayerLabel.LabelList)
            {
