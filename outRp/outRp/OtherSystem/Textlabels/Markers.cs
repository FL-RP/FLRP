...
namespace outRp.OtherSystem.Textlabels
{
    ...
    public class Marker : Entity, IEntity
    {
        ...
        public string DisplayName
        {
            get
            {
                if (!TryGetData("DisplayName", out string DisplayName))
                    return null;
            ...
            {
                if (value == null)
                    SetData("DisplayName", null);               

                SetData("DisplayName", value);
            }            
        }

        public bool isBusinessMarker
        {
            get
            {
                if (!TryGetData("isBusinessMarker", out bool isBusinessMarker))
                    return false;

                return isBusinessMarker;
            }
            set
            {
                if (isBusinessMarker == value)
                    return;

                SetData("isBusinessMarker", value);
            }
        }
        ...
        public void Destroy()
        {
            if (Marker.MarkerList.Contains(this))
    ...
    public static class MarkerStreamer
    {
        ...
        public static bool Delete(ulong dynamicMarkerId)
        {
            ...
            if(Marker.MarkerList.Contains(marker))
        ...
        {
            List<Marker> markers = new List<Marker>(Marker.MarkerList);
